    ...
    <div className="space-y-8 text-white">
      <div className="space-y-3">
        ...
        <p className="max-w-2xl text-sm leading-7 text-[rgba(243,251,255,0.7)] md:text-base">
          Budget tools are on the way. Set category limits and track your
          monthly goals here soon.
        </p>
      </div>
      ...
      <div className="digital-panel-strong rounded-4xl p-6 md:p-8">
        <p className="max-w-3xl text-base leading-8 text-[rgba(243,251,255,0.78)]">
          Budget tools are on the way. Set category limits and track your
          monthly goals here soon.
        </p>
      </div>
